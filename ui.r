                   ...
                   tags$div(
                    style = "background-color: lightblue; padding: 15px;",
                      box(
                        ...
                        solidHeader = TRUE,
                        status = "success",
                    tags$p("Welcome to our cutting-edge dashboard, where we look at a decade's worth of statistical data on NCAA Division 1 basketball teams. The postseason
                      period of college basketball, coined March Madness, is one of the most revered sporting events of all time. Statistical data covers both in-season and 
                      post-season information, including important points such as power ranking, win percentage,
